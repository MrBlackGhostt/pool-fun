...
use anchor_spl::metadata::{create_metadata_accounts_v3, CreateMetadataAccountsV3, Metadata,ID as METADATA_PROGRAM_ID, mpl_token_metadata::types::DataV2};

use crate::states::CurveConfiguration;

pub fn initialize_curve(ctx: Context<Initialize>,name:String, symbol:String, uri:String) -> Result<()> {
...
let cpi_ctx = CpiContext::new_with_signer(ctx.accounts.token_metadata_program.to_account_info(),
